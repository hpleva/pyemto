...
emtopath = os.getcwd() + "/fe_elastic_constants" # Define a folder for our KGRN and KFCD input and output files.
latpath  = os.getcwd() + "/fe_elastic_constants" # Define a folder where the BMDL, KSTR and KFCD input and output files
                               # will be located.
